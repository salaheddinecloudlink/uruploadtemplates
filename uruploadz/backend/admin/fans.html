...
<head>
    ...
    <link rel="stylesheet" href="../plugins/data-table/dataTables.bootstrap4.css">
    <link rel="stylesheet" href="../plugins/data-table/responsive.dataTables.min.css">
    <!-- animation CSS -->
...
<body class="fix-sidebar fix-header">
    ...
    <script src="../plugins/data-table/dataTables.responsive.min.js"></script>
